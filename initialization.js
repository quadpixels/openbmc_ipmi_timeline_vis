...
document.getElementById("btn_open_file").addEventListener("click", OpenFileHandler);
document.getElementById("btn_open_file2").addEventListener("click", OpenFileHandler);
...
document.getElementById("bah3").addEventListener("click", OnGroupByConditionChanged_ASIO);
...
var g_group_by_asio = document.getElementById("span_group_by_boost_asio_handler");
...
function HideWelcomeScreen() { g_WelcomeScreen.style.display = "none"; }
